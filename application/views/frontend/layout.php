...
<head>
    ...
    <!-- Website Title -->
    <title>Portal Data Banyuwangi</title>
	...
	<!-- Favicon  -->
    <link rel="icon" href="<?php echo base_url()?>assets/frontend/images/logo_baru.png">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <!-- <a class="navbar-brand logo-image" href="index.html"><img src="<?php echo base_url()?>assets/frontend/images/logo_baru.png" alt="alternative"></a> -->
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#banyuwangi_data">Banyuwangi Data</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#connect_data">Connect Data</a>
                </li>
                <!-- <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-col">
                        <h4>Portal Data Banyuwangi</h4>
                        <p>Menggunakan data secara bersama-sama dengan perlengkapan visualisasi data yang menarik. Konsep Banyuwangi Data dapat meningkatkan kinerja dalam melayani SKPD dan pertukaran data.</p>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-4">
