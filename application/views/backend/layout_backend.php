...
<head>
	...
	<title>Portal Data | Dashboard Admin</title>
	<meta name="description" content="Ecommerce Dashboard">
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-114x114.png">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-144x144.png">
	<link rel="apple-touch-icon-precomposed" sizes="60x60" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-60x60.png">
	<link rel="apple-touch-icon-precomposed" sizes="120x120" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-120x120.png">
	<link rel="apple-touch-icon-precomposed" sizes="76x76" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-76x76.png">
	<link rel="apple-touch-icon-precomposed" sizes="152x152" href="<?php echo base_url()?>assets/backend/img\favicon\apple-touch-icon-152x152.png">
	<link rel="icon" type="image/png" href="<?php echo base_url()?>assets/backend/img\favicon\favicon-196x196.png" sizes="196x196">
	<link rel="icon" type="image/png" href="<?php echo base_url()?>assets/backend/img\favicon\favicon-96x96.png" sizes="96x96">
	<link rel="icon" type="image/png" href="<?php echo base_url()?>assets/backend/img\favicon\favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="<?php echo base_url()?>assets/backend/img\favicon\favicon-16x16.png" sizes="16x16">
	<link rel="icon" type="image/png" href="<?php echo base_url()?>assets/backend/img\favicon\favicon-128.png" sizes="128x128">
	<meta name="application-name" content="&nbsp;">
	<meta name="msapplication-TileColor" content="#FFFFFF">
	<meta name="msapplication-TileImage" content="<?php echo base_url()?>assets/backend/img/favicon/mstile-144x144.png">
	<meta name="msapplication-square70x70logo" content="<?php echo base_url()?>assets/backend/img/favicon/mstile-70x70.png">
	<meta name="msapplication-square150x150logo" content="<?php echo base_url()?>assets/backend/img/favicon/mstile-150x150.png">
	<meta name="msapplication-wide310x150logo" content="<?php echo base_url()?>assets/backend/img/favicon/mstile-310x150.png">
	<meta name="msapplication-square310x310logo" content="<?php echo base_url()?>assets/backend/img/favicon/mstile-310x310.png">
	<link rel="preconnect" href="https://fonts.gstatic.com">
	<link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@300;400;600&display=swap" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;700&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url()?>assets/backend/font/CS-Interface/style.css">
	<link rel="stylesheet" href="<?php echo base_url()?>assets/backend/css/vendor/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo base_url()?>assets/backend/css/vendor/OverlayScrollbars.min.css">
		...
		<div id="nav" class="nav-container d-flex">
			<div class="nav-content d-flex">
				...
				<div class="user-container d-flex">
					<a href="" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<img class="profile" alt="profile" src="<?php echo base_url()?>assets/backend/img/logo/logo_baru.png">
							...
							<div class="scroll">
								<ul class="list-unstyled border-last-none">
									<li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
										<img src="<?php echo base_url()?>assets/backend/img\profile\profile-1.jpg" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="...">
										<div class="align-self-center">
                      <a href="#">Joisse Kaycee just sent a new comment!</a>
										</div>
									</li>
									<li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
										<img src="<?php echo base_url()?>assets/backend/img\profile\profile-2.jpg" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="...">
										<div class="align-self-center">
                      <a href="#">New order received! It is total $147,20.</a>
										</div>
									</li>
									<li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
										<img src="<?php echo base_url()?>assets/backend/img\profile\profile-3.jpg" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="...">
										<div class="align-self-center">
                      <a href="#">3 items just added to wish list by a user!</a>
										</div>
									</li>
									<li class="pb-3 pb-3 border-bottom border-separator-light d-flex">
										<img src="<?php echo base_url()?>assets/backend/img\profile\profile-6.jpg" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="...">
										<div class="align-self-center">
          ...
          <li class="list-inline-item">
            <a href="<?php echo base_url()?>login/logout">
              <i data-cs-icon="logout" data-cs-size="18"></i>
            </a>
          </li>
				...
				<div class="menu-container flex-grow-1">
					<ul id="menu" class="menu">
						<li id="mn" onclick="load('backend/dashboard','#contents'); switch_menu(this);">
                ...
                <i data-cs-icon="home" class="icon" data-cs-size="18"></i>
						...
						<li>
							<a href="#portal_data" data-href="Products.html">
                <i data-cs-icon="database" class="icon" data-cs-size="18"></i>
								<span  class="label">Portal Data</span>
							</a>
							<ul id="portal_data">
								<li>
									<a href="Products.List.html"><i data-cs-icon="book"></i>
                    <span  class="label"> Data BPS</span>
									</a>
								</li>
								<li>
									<a href="Products.Detail.html"><i data-cs-icon="book"></i>
                    <span class="label">Data Sektoral</span>
									</a>
								</li>
							</ul>
						</li><br>
                ...
                <i data-cs-icon="gear" class="icon" data-cs-size="18"></i>
							...
							<ul id="master">
								<li>
									<a href="#"><i data-cs-icon="user"></i>
                    <span class="label">Pengguna</span>
									</a>
								</li>
								<li>
									<a href="#"><i data-cs-icon="home-garage"></i>
                    <span class="label">SKPD</span>
									</a>
								</li>
                <li>
                  <a href="#"><i data-cs-icon="quiz"></i>
                    <span class="label">Urusan</span>
                  </a>
                </li>
                <li>
                  <a href="#"><i data-cs-icon="form-check"></i>
...
<a href="https://1.envato.market/BX5oGy" target="_blank" class="btn-link">Purchase</a>
								...
								<li class="breadcrumb-item mb-0 text-medium"><a href="https://acorn-html-docs.coloredstrategies.com/" target="_blank" class="btn-link">Docs</a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="mb-5">
							...
							<div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
								<div class="position-relative mb-3 mb-lg-5 rounded-sm">
									...
									<div class="position-absolute reveal-content rounded-sm absolute-center-vertical text-center w-100">
<a target="_blank" href="index.htm" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1">
Html
</a>
...
.Net5
	...
	<script src="<?php echo base_url()?>assets/backend/js/vendor/bootstrap.bundle.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/OverlayScrollbars.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/autoComplete.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/clamp.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/Chart.bundle.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/chartjs-plugin-rounded-bar.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/vendor/jquery.barrating.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/font/CS-Line/csicons.min.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/base/helpers.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/base/globals.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/base/nav.js"></script>
	<!-- <script src="<?php echo base_url()?>assets/backend/js/base/search.js"></script> -->
	<script src="<?php echo base_url()?>assets/backend/js/base/settings.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/base/init.js"></script>
	<script src="<?php echo base_url()?>assets/backend/js/cs/charts.extend.js"></script>
  ...
  <script>
        ...
        function change_periode(periode){
            if (periode) {
                $.post(site+'main/periode', {
                    periode: periode
                    }, function(data) {
                });
            }
