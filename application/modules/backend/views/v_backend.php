...
<div class="content-body">
	...
	<div class="container-fluid">
		<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
			<div class="mr-auto">
				<h2 class="text-black font-w600">Super Admin</h2>
				<p class="mb-0">Satu Data Banyuwangi</p>
			</div>
		...
		<div class="row">
			<div class="col-xl-3 col-sm-6">
				<div class="card">
					...
					<div class="progress  rounded-0" style="height:4px;">
						<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: 50%; height:4px;" role="progressbar">	<span class="sr-only">50% Complete</span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xl-3  col-sm-6">
				<div class="card">
					...
					<div class="progress  rounded-0" style="height:4px;">
						<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: 90%; height:4px;" role="progressbar">	<span class="sr-only">90% Complete</span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xl-3  col-sm-6">
				<div class="card">
					...
					<div class="progress  rounded-0" style="height:4px;">
						<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: 30%; height:4px;" role="progressbar">	<span class="sr-only">30% Complete</span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xl-3  col-sm-6">
				<div class="card">
					...
					<div class="progress  rounded-0" style="height:4px;">
						<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: 94%; height:4px;" role="progressbar">	<span class="sr-only">94% Complete</span>
						</div>
					</div>
				</div>
			</div>
									...
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										...
										<div class="card-action card-tabs mt-3 mt-sm-0 mt-3 mb-sm-0 mb-3 mt-sm-0">
											<ul class="nav nav-tabs" role="tablist">
												<li class="nav-item">	<a class="nav-link active" data-toggle="tab" href="#Daily" role="tab">
														Daily
													</a>
												</li>
												<li class="nav-item">	<a class="nav-link" data-toggle="tab" href="#Weekly" role="tab">
														Weekly
													</a>
												</li>
												<li class="nav-item">	<a class="nav-link" data-toggle="tab" href="#Monthly" role="tab">
														Monthly
													</a>
												</li>
											</ul>
										...
										<div class="tab-content">
											<div class="tab-pane fade show active" id="Daily" role="tabpanel">
												<div class="d-flex flex-wrap align-items-center px-4 bg-light">
													<div class="mr-auto d-flex align-items-center py-3">	<span class="heart-ai bg-primary mr-3">
															<i class="fa fa-heart-o" aria-hidden="true"></i>
														</span>
														<div>
															<p class="fs-18 mb-2">Total Patient</p>	<span class="fs-26 text-primary font-w600">562,084</span>
														</div>
													</div>
													<ul class="users pl-3 py-2">
														<li>
															<img src="<?php echo base_url()?>assets_backend/backend/images/users/1.png" alt="">
														</li>
														<li>
															<img src="<?php echo base_url()?>assets_backend/backend/images/users/2.png" alt="">
														</li>
														<li>
															<img src="<?php echo base_url()?>assets_backend/backend/images/users/3.png" alt="">
														</li>
														<li>
															<img src="<?php echo base_url()?>assets_backend/backend/images/users/4.png" alt="">
														</li>
														<li>
															<img src="<?php echo base_url()?>assets_backend/backend/images/users/5.png" alt="">
														</li>
													</ul>
												</div>
												<div class="row align-items-center">
													...
													<div class="col-xl-6 col-xxl-12 col-md-6">
														<div class="d-flex mb-4 align-items-center">	<span class="mr-auto pr-3 font-w500 fs-30 text-black">
														...
														<div class="d-flex align-items-center">	<span class="mr-auto pr-3 font-w500 fs-30 text-black">
																<svg class="mr-3" width="8" height="30" viewBox="0 0 8 30" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="tab-pane fade" id="Weekly" role="tabpanel">
												<div class="d-flex flex-wrap align-items-center px-4  bg-light">
													<div class="mr-auto py-3 d-flex align-items-center">	<span class="heart-ai bg-primary mr-3">
															<i class="fa fa-heart-o" aria-hidden="true"></i>
														</span>
														<div>
															<p class="fs-18 mb-2">Total Patient</p>	<span class="fs-26 text-primary font-w600">786,360</span>
														</div>
													</div>
													<ul class="users pl-3 py-2">
														<li>
											...
											<div class="tab-pane fade" id="Monthly" role="tabpanel">
												<div class="d-flex flex-wrap align-items-center px-4  bg-light">
													<div class="mr-auto py-3 d-flex align-items-center">	<span class="heart-ai bg-primary mr-3">
														...
														<div>
															<p class="fs-18 mb-2">Total Patient</p>	<span class="fs-26 text-primary font-w600">356,730</span>
														</div>
													</div>
													<ul class="users pl-3 py-2">
														<li>
									...
									<div class="card-header d-block border-0 pb-0">
										<div class="d-flex mb-3">
											...
											<div class="dropdown ml-auto">
												...
												<div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item text-black" href="javascript:;">Info</a>
										...
										<div class="d-flex">
											<div class="d-flex mr-auto align-items-center">
												...
												<div class="ml-2">
													<p class="mb-1">New</p>	<span class="text-black font-w500">451</span>
												</div>
											</div>
											<div class="d-flex align-items-center">
												...
												<div class="ml-2">
													<p class="mb-1">Recovered</p>	<span class="text-black font-w500">623</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										<ul class="users-sm mb-3">
											<li>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/6.png" alt="">
											</li>
											<li>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/7.png" alt="">
											</li>
											<li>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/8.png" alt="">
											</li>
											<li>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/9.png" alt="">
											</li>
											<li>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/10.png" alt="">
											</li>
										</ul>
										<div class="d-flex align-items-center">
											...
											<div>
												<p class="fs-12 mb-0">Customer</p>	<span class="fs-22 text-black font-w600">765 Person</span>
											</div>
										</div>
								...
								<div class="card rated-doctors">
									...
									<div class="card-body">
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#1</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/1.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												</ul>	<span class="fs-14 text-black">315 reviews</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#2</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/2.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												</ul>	<span class="fs-14 text-black">221 reviews</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#3</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/3.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												</ul>	<span class="fs-14 text-black">181 reviews</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#4</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/4.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#5</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/5.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												</ul>	<span class="fs-14 text-black">176 reviews</span>
											</div>
										</div>
										<div class="d-sm-flex pb-0 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">	<span class="num mr-sm-4 mr-3">#6</span>
												<img src="<?php echo base_url()?>assets_backend/backend/images/users/1.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" class="text-black">Dr. Abdul Aziz Lazis</a></h4>
													<span class="fs-14 text-primary font-w600">Gynecologist</span>
						...
						<div class="row">
										...
										<div class="row">
											...
											<div class="col-xl-6 col-xxl-12  col-md-6 height415 dz-scroll" id="appointment-schedule">
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													...
													<a href="javascript:void(0)" class="text-success mr-3 mb-2">	<i class="las la-check-circle scale5"></i>
													</a>
													<a href="javascript:void(0)" class="text-danger mb-2">	<i class="las la-times-circle scale5"></i>
													</a>
												</div>
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
								...
								<div class="card">
									<div class="card-header border-0 pb-0">
										...
										<div class="dropdown mt-sm-0 mt-3">
											<button type="button" class="btn bg-light text-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">2020</button>
											<div class="dropdown-menu dropdown-menu-right">	<a class="dropdown-item" href="javascript:void(0);">2020</a>
							...
							<div class="col-xl-12">
								<div class="card patient-activity">
											...
											<table class="table table-responsive-sm">
												<tbody>
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/6.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Disease</p>	<span class="text-primary font-w600 mb-auto">Allergies & Asthma</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-primary font-w600 mb-2 d-block text-nowrap">Recovered</span>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/7.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Disease</p>	<span class="text-primary font-w600 mb-auto">Sleep Problem</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-danger font-w600 mb-2 text-nowrap d-block">New Patient</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/8.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Disease</p>	<span class="text-primary font-w600 mb-auto">Dental Care</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-warning font-w600 mb-2 text-nowrap d-block">In Treatment</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/9.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Disease</p>	<span class="text-primary font-w600 mb-auto">Diabetes</span>
															</div>
														</td>
														<td>
															<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/10.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Disease</p>	<span class="text-primary font-w600 mb-auto">Covid-19 Suspect</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-warning font-w600 text-nowrap mb-2 d-block">In Treatment</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														<td>
															<div class="d-flex">
																<img src="<?php echo base_url()?>assets_backend/backend/images/users/11.jpg" alt="" class="img-2 mr-3">
																<div>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-primary font-w600 mb-2 text-nowrap d-block">Recovered</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-warning font-w600 mb-2 d-block text-nowrap">In Treatment</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>	<span class="text-danger font-w600 mb-2 d-block text-nowrap">New Patient</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
									...
									<div class="card-footer text-center border-0">	<a href="patient.html" class="btn-link">See More >></a>
									</div>
								</div>
							</div>
						</div>
